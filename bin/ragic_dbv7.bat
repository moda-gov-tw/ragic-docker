...
if exist "%RAGIC_HOME%\bin\ragic_dbv7.bat" goto okHome
cd ..
set "RAGIC_HOME=%cd%"
:gotHome
if exist "%RAGIC_HOME%\bin\ragic_dbv7.bat" goto okHome
...
if exist "%RAGIC_HOME%\bin\setclasspath_dbv7.bat" goto okSetclasspath
echo Cannot find "%RAGIC_HOME%\bin\setclasspath_dbv7.bat"
echo This file is needed to run this program
goto end
:okSetclasspath
set "BASEDIR=%RAGIC_HOME%"
call "%RAGIC_HOME%\bin\setclasspath_dbv7.bat" %1
